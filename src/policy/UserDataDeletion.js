export default function UserDataDeletion() {
    return (
        <div>
            ...
            <p>If you would like to delete your personal information from our Service, please follow these instructions:</p>
            <ol>
                <li>Sign in to your account and navigate to the Settings page.</li>
                <li>Click on the "Delete Account" button.</li>
                <li>Follow the prompts to confirm the deletion of your account.</li>
            </ol>
